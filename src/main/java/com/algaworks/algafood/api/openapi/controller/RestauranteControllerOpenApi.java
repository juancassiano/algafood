...
public interface RestauranteControllerOpenApi {
    ...
    public RestauranteModel atualizar(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long restauranteId,
    ...
    public void ativar(@ApiParam(value = "ID de um restaurante", example = "1", required = true)
                                   Long restauranteId);
